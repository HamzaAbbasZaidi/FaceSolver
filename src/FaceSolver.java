...
public class FaceSolver {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (StringVerifier.verifyString(a)) {
            ...
            switch (a.charAt(4)) {
                ...
                default -> {
                    ...
                    solution = new String("x2 ");
                }
            }

            String ULSticker = String.valueOf(a.charAt(3));
            ...
            String UFLSticker = String.valueOf(a.charAt(6));
            ...
            String UFSticker = String.valueOf(a.charAt(7));
            ...
            String URSticker = String.valueOf(a.charAt(5));
            ...
            String UFRSticker = String.valueOf(a.charAt(8));
            ...
            String UBSticker = String.valueOf(a.charAt(1));
            ...
            String UBLSticker = String.valueOf(a.charAt(0));
            ...
            String UBRSticker = String.valueOf(a.charAt(2));
            ...
            System.out.println("Impossible combination entered");
        }
    }
